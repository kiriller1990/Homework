...
//Test 1
    ...
    public void glueTest(String expectedString, String str1, String str2) {
        // GIVEN
...
//test 2
    public  static Stream<Arguments> indexOfProviderArguments() {
        return Stream.of(
    ...
    public void symbolIndexTest(int expectedInt, String str1, String str2) {
            // GIVEN
...
//test 3
    public static Stream<Arguments> equalsProviderArguments() {
        return Stream.of(
    ...
    public void stringComparisonTest(boolean expectedBoolean, String str1, String str2) {
        // GIVEN
...
//test 4
    public static Stream<Arguments> trimProviderArguments() {
        return Stream.of(
                Arguments.of("HELLO", " Hello "),
                Arguments.of("HELLO", " hello"),
    ...
    public void trimAndUpperCaseTest(String expectedString, String str1) {
        // GIVEN
...
//test 5
    public static Stream<Arguments> substringProviderArguments() {
        return Stream.of(
    ...
    public void stringRetrievalTest(String expectedString, String str,int startIndex,int  endIndex) {
        // GIVEN
...
//test 6
    public static Stream<Arguments> replaceProviderArguments() {
        return Stream.of(
    ...
    public void replaceSmylesTest(String expectedString, String str,String letter1,String letter2) {
        // GIVEN
...
//test 7
    public static Stream<Arguments> startWithProviderArguments() {
        return Stream.of(
    ...
    public void comparisonStartEndLastWordsTest(boolean expectedBoolean, String text, String word) {
        // GIVEN
...
//test 8
    public static Stream<Arguments> countVowelsInTextProviderArguments() {
        return Stream.of(
    ...
    public void numberOfEnglishVowelsTest(int expectedInt, String text) {
        // GIVEN
...
//test 9
    public static Stream<Arguments> numberOfPunctuationsMarksProviderArguments() {
        return Stream.of(
                Arguments.of(3, ".<?!"),
                Arguments.of(0, ""),
    ...
    public void numberOfPunctuationsMarksTest(int expectedInt, String text) {
        // GIVEN
...
//test 10
    public static Stream<Arguments> palindromeProviderArguments() {
        return Stream.of(
    ...
    public void palindromeTest(boolean expectedBoolean, String text) {
        // GIVEN
...
//test 11
    public static Stream<Arguments> splitArrayProviderArguments() {
        return Stream.of(
    ...
    public void splitArrayTest(String[] expected, String text,int n) {
        // GIVEN
...
//test 12
    public static Stream<Arguments> wordsCountProvideArguments() {
        return Stream.of(
    ...
    public void wordsCountTest(String text, int expected) {
        int actual = StringUtil.wordsCount(text);
        Assertions.assertEquals(expected, actual);
    }
//test 13
    public static Stream<Arguments> initialsProvideArguments() {
        return Stream.of(
    ...
    public void patternInitialsTest(String text, String expected) {
        String actual = StringUtil.initials(text);
        Assertions.assertEquals(expected, actual);
    }
// test 14
    public static Stream<Arguments> digitStringPovideArguments() {
        return Stream.of(
    ...
    public void digitStringTest(String text, String expected) {
